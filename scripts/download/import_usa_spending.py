...
def parse_json_file(filepath: Path) -> List[Dict]:
    ...
    try:
        ...
        for result in data.get("results", []):
            ...
            award_date = result.get(
                "Award Date", result.get("period_of_performance_start_date", "")
            )
            ...
            record = {
                ...
                "awarding_agency": result.get(
                    "Awarding Agency", result.get("awarding_agency_name", "")
                ),
                "awarding_sub_agency": result.get(
                    "Awarding Sub Agency", result.get("awarding_sub_agency_name", "")
                ),
                ...
                "place_congressional_district": result.get(
                    "place_of_performance_congressional_district", ""
                ),
                "generated_award_id": result.get(
                    "generated_internal_id", result.get("Award ID", "")
                ),
        ...
        try:
            ...
            """,
                (
                    ...
                    r["place_state"],
                    r["place_zip"],
                    r["place_congressional_district"],
                    r["generated_award_id"],
                    r["raw_data"],
                    r["source_file"],
                ),
            )
