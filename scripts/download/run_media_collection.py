            ...
            for keywords in keywords_list:
                try:
                    ...
                    results = await self.news_agent.search(
                        keywords=keywords, date_range=(start_date, end_date), max_results=100
                    )
    ...
    async def discover_all_videos(self):
        ...
        for keywords in keywords_list:
            try:
                ...
                results = await self.video_agent.search(keywords=keywords, max_results=50)
                    ...
                    try:
                        self.storage.add_to_queue(
                            ...
                            metadata={
                                ...
                                "upload_date": video.publish_date.isoformat()
    ...
    async def discover_all_documents(self):
        ...
        for case in court_cases:
            try:
                ...
                results = await self.doc_agent.search(keywords=case, max_results=100)
                    ...
                    try:
                        self.storage.add_to_queue(
                            ...
                            metadata={
                                ...
                                "filing_date": doc.publish_date.isoformat()
                                if doc.publish_date
                                else None,
