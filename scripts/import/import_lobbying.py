        ...
        try:
            ...
            """,
                (
                    ...
                    r["client_zip"],
                    r["client_country"],
                    r["client_ppb_country"],
                    r["foreign_entity_name"],
                    r["foreign_entity_address"],
                    r["foreign_entity_city"],
                    r["foreign_entity_country"],
                    r["foreign_entity_ppb"],
                    r["registration_date"],
                    r["signature_date"],
                    r["registrant_id"],
                    r["client_id"],
        ...
        try:
            ...
            """,
                (
                    ...
                    r["registrant_name"],
                    r["client_name"],
                    r["lobbying_activity_period_start"],
                    r["lobbying_activity_period_end"],
                    r["income_amount"],
                    r["expenses_amount"],
                    r["termination_date"],
                    r["issues"],
                    r["specific_issues"],
                    r["houses_and_agencies"],
                    r["foreign_entity_interest"],
                    r["registrant_id"],
                    r["client_id"],
                    r["report_type"],
                    r["year"],
