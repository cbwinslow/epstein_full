        ...
        if result:
            ...
            if existing_hash != script_hash:
                ...
                cur.execute("""
                    ...
                    WHERE id = %s
                """, (script_content, script_hash, str(script_path), description, version, existing_id))
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Example: python register_download_script.py download_congress_historical.py 'Downloads Congress.gov historical data' '1.0.0'")
        sys.exit(1)
