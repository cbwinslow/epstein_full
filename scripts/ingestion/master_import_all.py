...
from scripts.utils.epstein_config import ensure_dirs
from scripts.utils.tracker import done_task, register_task, update_task
...
class IngestionOrchestrator:
    ...
    async def run_dependencies(self, source_name: str) -> bool:
        ...
        # Define dependencies
        dependencies = {"hf": ["doj", "jmail"], "third_party": ["doj", "jmail", "icij"]}
