...
with conn.cursor() as cur:
    ...
    gov_tables = [
        'congress_members', 'congress_bills',
        'fec_candidates', 'fec_committees', 'fec_candidate_committee_links', 'fec_pac_summary', 'fec_individual_contributions',
        'govinfo_packages', 'federal_register_entries', 'court_opinions',
        'fara_registrations', 'fara_foreign_principals',
        'lobbying_registrations', 'lobbying_quarterly_reports',
        'whitehouse_visitors', 'usa_spending_awards',
        'house_financial_disclosures', 'senate_financial_disclosures'
    ]
