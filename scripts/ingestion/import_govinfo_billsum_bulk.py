...
def get_or_create_bill(cur, congress: int, bill_type: str, bill_number: str, title: str, latest_summary: str, source_file: str) -> int:
    cur.execute(
        """
        SELECT id
        FROM congress_bills
...
def insert_summary(cur, bill_id: int, version_code: str, current_chamber: str, action_date: Optional[str], action_desc: str, update_date: Optional[str], summary_text: str, source_file: str):
    cur.execute(
        """
    ...
    try:
        with zipfile.ZipFile(zip_path) as archive:
            for member in archive.namelist():
                ...
                bill_id = get_or_create_bill(cur, congress, bill_type, bill_number, title, latest_summary, source_file)
                stats["bills"] += 1
                ...
                for summary in summaries:
                    ...
                    insert_summary(cur, bill_id, version_code, current_chamber, action_date, action_desc, update_date, summary_text, source_file)
