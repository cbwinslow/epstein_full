...
class HistoricalCollectionManager:
    ...
    def __init__(
        self, state_file: str = "/home/cbwinslow/workspace/epstein-data/.collection_state.json"
    ):
    ...
    def _load_state(self) -> dict:
        ...
        if os.path.exists(self.state_file):
            try:
                ...
                pass
        return {"completed_batches": [], "failed_urls": [], "last_run": None, "total_collected": 0}
...
async def collect_historical_data(
    domains: List[str], keywords: List[str], start_year: int, end_year: int, output_file: str
):
...
if __name__ == "__main__":
    ...
    # Configuration
    from media_acquisition.config import EPSTEIN_KEYWORDS, SEPT11_KEYWORDS, TARGET_SOURCES
