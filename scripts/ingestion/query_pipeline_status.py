...
for row in cur.fetchall():
    source_name, source_type, download_status, ingestion_status, target_table, records_imported, priority, notes = row
    print(f"{source_name:<35} {source_type:<12} {download_status:<12} {ingestion_status:<12} {records_imported:>12,} {priority:<8}")
    if notes:
        print(f"  └─ {notes}")
