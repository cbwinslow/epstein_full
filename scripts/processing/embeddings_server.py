...
async def embed_texts(
    request: EmbedRequest, credentials: HTTPAuthorizationCredentials = Depends(security)
):
    ...
    embeddings = model.encode(
        request.texts, batch_size=request.batch_size, show_progress_bar=True, convert_to_numpy=True
    )
...
async def semantic_search(
    request: SearchRequest, credentials: HTTPAuthorizationCredentials = Depends(security)
):
