...
TIER_1_SOURCES = [
    ...
    NewsSource(
        "Financial Times", "ft.com", rate_limit_seconds=2.0, priority=2, reliability_score=0.9
    ),
    NewsSource(
        "Bloomberg", "bloomberg.com", rate_limit_seconds=2.0, priority=2, reliability_score=0.9
    ),
    NewsSource(
        "Economist",
        "economist.com",
...
TIER_3_SOURCES = [
    ...
    NewsSource(
        "Legal Times", "legaltimes.com", rate_limit_seconds=1.5, priority=2, reliability_score=0.85
    ),
    NewsSource("Law360", "law360.com", rate_limit_seconds=2.0, priority=1, reliability_score=0.9),
    NewsSource(
        "National Law Journal", "law.com", rate_limit_seconds=2.0, priority=2, reliability_score=0.9
    ),
    NewsSource(
        "Legal Insurrection",
...
TIER_4_SOURCES = [
    ...
    NewsSource(
        "Telegraph", "telegraph.co.uk", rate_limit_seconds=1.5, priority=3, reliability_score=0.85
    ),
    NewsSource("Le Monde", "lemonde.fr", rate_limit_seconds=2.0, priority=3, reliability_score=0.9),
    NewsSource(
        "Der Spiegel", "spiegel.de", rate_limit_seconds=2.0, priority=3, reliability_score=0.9
    ),
    NewsSource(
    ...
    NewsSource(
        "Haaretz", "haaretz.com", rate_limit_seconds=2.0, priority=4, reliability_score=0.85
    ),
    NewsSource(
        "Jerusalem Post", "jpost.com", rate_limit_seconds=1.5, priority=4, reliability_score=0.8
    ),
    NewsSource(
        "Al Jazeera",
        "aljazeera.com",
    ...
    NewsSource(
        "France 24", "france24.com", rate_limit_seconds=1.5, priority=4, reliability_score=0.85
    ),
    NewsSource(
        "Deutsche Welle", "dw.com", rate_limit_seconds=1.5, priority=4, reliability_score=0.85
    ),
    NewsSource(
        "BBC US & Canada",
        "bbc.com",
    ...
    NewsSource("Canada CBC", "cbc.ca", rate_limit_seconds=1.5, priority=4, reliability_score=0.85),
    NewsSource(
        "Australian ABC", "abc.net.au", rate_limit_seconds=1.5, priority=4, reliability_score=0.85
    ),
]
...
TIER_5_SOURCES = [
    ...
    NewsSource(
        "Barron's", "barrons.com", rate_limit_seconds=2.0, priority=3, reliability_score=0.9
    ),
    NewsSource(
        "Investment News",
        "investmentnews.com",
    ...
    NewsSource(
        "Hedge Fund Alert", "hfalert.com", rate_limit_seconds=2.0, priority=4, reliability_score=0.8
    ),
    NewsSource(
        "DealBook NYT",
        "nytimes.com",
...
TIER_6_SOURCES = [
    ...
    NewsSource(
        "Truthdig", "truthdig.com", rate_limit_seconds=1.0, priority=4, reliability_score=0.75
    ),
    NewsSource(
        "MintPress News",
        "mintpressnews.com",
    ...
    NewsSource(
        "Grayzone", "thegrayzone.com", rate_limit_seconds=1.0, priority=4, reliability_score=0.7
    ),
    NewsSource(
        "Consortium News",
        "consortiumnews.com",
    ...
    NewsSource(
        "Shadowproof", "shadowproof.com", rate_limit_seconds=1.0, priority=4, reliability_score=0.7
    ),
    NewsSource(
        "The Nation",
        "thenation.com",
...
TIER_7_SOURCES = [
    ...
    NewsSource(
        "Daily Wire", "dailywire.com", rate_limit_seconds=1.0, priority=4, reliability_score=0.7
    ),
    NewsSource("Newsmax", "newsmax.com", rate_limit_seconds=1.0, priority=3, reliability_score=0.7),
    NewsSource(
        "American Thinker",
        "americanthinker.com",
        rate_limit_seconds=1.0,
    ...
    NewsSource(
        "Spectator", "spectator.org", rate_limit_seconds=1.0, priority=4, reliability_score=0.8
    ),
    NewsSource(
        "New York Sun", "nysun.com", rate_limit_seconds=1.5, priority=4, reliability_score=0.8
    ),
    NewsSource(
        "Epoch Times",
        "theepochtimes.com",
...
TIER_8_SOURCES = [
    ...
    NewsSource(
        "Us Weekly", "usmagazine.com", rate_limit_seconds=1.0, priority=4, reliability_score=0.65
    ),
    NewsSource(
